...
public class IntroActivity extends AppCompatActivity {
    ...
    private void goToMyNotes() {
        Intent intent = new Intent(IntroActivity.this, MyNotes.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toMyNotes = findViewById(R.id.toMyNotes);
        toMyNotes.setOnClickListener(new View.OnClickListener() {
            @Override
